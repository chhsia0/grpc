...
CORE_VERSION_MAJOR = $(shell echo $(CORE_VERSION) | cut -f 1 -d.)
CPP_VERSION_MAJOR = $(shell echo $(CPP_VERSION) | cut -f 1 -d.)
CSHARP_VERSION_MAJOR = $(shell echo $(CSHARP_VERSION) | cut -f 1 -d.)
